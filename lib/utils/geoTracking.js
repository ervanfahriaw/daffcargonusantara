/**
 * GeoTracking Utility (JS Runtime / Node Test Runner version)
 */

export const PELABUHAN_COORDINATES = {
...
export const BANDARA_COORDINATES = {
...
export function resolveCoordinatesForLocation(locationStr, moda = "darat") {
...
export function interpolatePositionOnRoute(origin, destination, progress, isMaritimeCurve = false) {
...
export function getProgressForStatus(status, moda) {
  switch (status) {
    case "booking":
...
export function generatePublicTrackingUrl(pesananId, originUrl) {
  const base = originUrl || (typeof window !== "undefined" ? window.location.origin : "");
  return `${base}/lacak/${pesananId}`;
}

export function generateCustomerTrackingMessage(pesanan, trackingUrl) {
